            ...
            children: [
              ...
              AppBar(
                ...
                actions: [
                  IconButton(
                      onPressed: () =>
                          context.push('/setupBudget', extra: true),
                                  ...
                                  PieChart(
                                    dataMap: {
                                      "Online Shopping": provider
                                          .budget["onlineShopping"]
                                          .toDouble(),
                                      "Dining":
                                          provider.budget["dining"].toDouble(),
                                      "Fuel":
                                          provider.budget["fuel"].toDouble(),
                                      ...
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            return createTile(
                                                ...
                                                total: provider.spent[
                                                    provider.categories[index]],
                                                limit: provider.budget[provider
                                                    .categories[index]]);
                                          })),
                                ],
                              );
...
Widget createTile(
    {required String title, required int total, required int limit}) {
  return ListTile(
    title: Text(
      title,
